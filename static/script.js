...
$( document ).ready( function() {
    ...
    $.get( 'https://airazon.github.io/candy-cal-SVc/problem.txt', function( problemTemplate ) {
        var i, len;
        
        // read Pokémon names and experience curves
        $.getJSON( 'https://airazon.github.io/candy-calc-SV/static/pokemon.json', function( pokemonData ) {
            var slug, slugs;
